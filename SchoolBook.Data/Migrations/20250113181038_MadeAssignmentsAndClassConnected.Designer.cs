...
namespace SchoolBook.Data.Migrations
{
    ...
    [Migration("20250113181038_MadeAssignmentsAndClassConnected")]
    partial class MadeAssignmentsAndClassConnected
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "859afee9-d34b-40ef-982d-28297e4b4d41",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBCtNlVUtIzbKfMHAG+Q4/lmw8DE46L95B9f2pYtQy/k34yOV5HKTYz63TxYSj1SAw==",
                            PhoneNumberConfirmed = false,
                            ProfileImgUrl = "https://img.freepik.com/free-photo/pretty-young-woman-portrait-outdoor_624325-3559.jpg",
                            SecurityStamp = "5913a333-bef6-4c35-8d3d-3213c21d30e0",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fab75318-09a5-4527-b1d0-b4a7ef450a60",
                            Email = "bob@gmail.com",
                            EmailConfirmed = true,
                            FirstName = "Bob",
                            LastName = "Smith",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENIAzlk6WDQXVEmkrJQpk7zZHe2F/Z5mK5gNfy9BDlPRwDILtlMBjm2oVTs6AOXpvg==",
                            PhoneNumberConfirmed = false,
                            ProfileImgUrl = "https://i1.sndcdn.com/avatars-pOLSo9QjSMPjQ6zF-D9J8mg-t500x500.jpg",
                            SecurityStamp = "87c84466-df9c-4fc9-99a3-cafda4ace666",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Assignment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AssignedDate = new DateTime(2025, 1, 13, 20, 10, 37, 883, DateTimeKind.Local).AddTicks(479),
                            ClassId = 1,
                            Deadline = new DateTime(2025, 1, 20, 20, 10, 37, 883, DateTimeKind.Local).AddTicks(480),
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.AssignmentSubmission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SubmissionDate = new DateTime(2025, 1, 13, 20, 10, 37, 883, DateTimeKind.Local).AddTicks(1436)
                        });
                });
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Attendance", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AttendanceDate = new DateTime(2025, 1, 12, 20, 10, 37, 883, DateTimeKind.Local).AddTicks(2343),
                            ClassId = 1,
                            IsPresent = false,
                            StudentId = "15713fda-d8ba-47fc-b70b-4cdf170fc78d"
                        });
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Exam", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExamDate = new DateTime(2025, 2, 13, 20, 10, 37, 883, DateTimeKind.Local).AddTicks(5013),
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Grade", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExamId = 1,
                            GradedDate = new DateTime(2025, 1, 13, 20, 10, 37, 883, DateTimeKind.Local).AddTicks(5950),
                            StudentId = "15713fda-d8ba-47fc-b70b-4cdf170fc78d"
                        });
                });
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassId = 1,
                            EnrollmentDate = new DateTime(2024, 10, 13, 20, 10, 37, 883, DateTimeKind.Local).AddTicks(6870),
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HireDate = new DateTime(2015, 1, 13, 20, 10, 37, 883, DateTimeKind.Local).AddTicks(8619),
