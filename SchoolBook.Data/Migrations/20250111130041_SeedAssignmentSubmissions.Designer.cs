...
namespace SchoolBook.Data.Migrations
{
    ...
    [Migration("20250111130041_SeedAssignmentSubmissions")]
    partial class SeedAssignmentSubmissions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8b96e778-7f32-47a8-9e15-c8db3a29a0c4",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBuF0mIqdPAHrt9bsbRSb46O9/MWOKUe54Ya6wIH6o938WRLQqDtEysTkvgF6291yA==",
                            PhoneNumberConfirmed = false,
                            ProfileImgUrl = "https://img.freepik.com/free-photo/pretty-young-woman-portrait-outdoor_624325-3559.jpg",
                            SecurityStamp = "c159b710-b4b2-4448-966d-3afecff7b830",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a17af3b2-61a3-4243-8e03-665f96a578a8",
                            Email = "bob@gmail.com",
                            EmailConfirmed = true,
                            FirstName = "Bob",
                            LastName = "Smith",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEN3nQMvjQbbbOjBs9aKpGbWOeaBuGKRmTVQoyq5Q6suGONexJNwFvcMKNwGbUNxNyw==",
                            PhoneNumberConfirmed = false,
                            ProfileImgUrl = "https://i1.sndcdn.com/avatars-pOLSo9QjSMPjQ6zF-D9J8mg-t500x500.jpg",
                            SecurityStamp = "4a9dd6d4-b141-46fc-a3f1-ab17fc400cc5",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Assignment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AssignedDate = new DateTime(2025, 1, 11, 15, 0, 40, 616, DateTimeKind.Local).AddTicks(9021),
                            Deadline = new DateTime(2025, 1, 18, 15, 0, 40, 616, DateTimeKind.Local).AddTicks(9023),
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.AssignmentSubmission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SubmissionDate = new DateTime(2025, 1, 11, 15, 0, 40, 617, DateTimeKind.Local).AddTicks(121)
                        });
                });
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassId = 1,
                            EnrollmentDate = new DateTime(2024, 10, 11, 15, 0, 40, 617, DateTimeKind.Local).AddTicks(2091),
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HireDate = new DateTime(2015, 1, 11, 15, 0, 40, 617, DateTimeKind.Local).AddTicks(4023),
