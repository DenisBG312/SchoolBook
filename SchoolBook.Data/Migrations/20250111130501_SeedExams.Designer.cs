...
namespace SchoolBook.Data.Migrations
{
    ...
    [Migration("20250111130501_SeedExams")]
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b9b2f1c9-1d53-4d2c-a982-5aa98792a30d",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHSVnMK6kajUxcvqRAuUPcHEfwZgdfUgf8JWGf88GSV7oPDV9kjLPfeyFvuz1mT/Hw==",
                            PhoneNumberConfirmed = false,
                            ProfileImgUrl = "https://img.freepik.com/free-photo/pretty-young-woman-portrait-outdoor_624325-3559.jpg",
                            SecurityStamp = "a0e3f827-b1c7-45cb-bd1c-b53ccfb8d532",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3313b53b-a03b-4f91-b0e6-3e104cb34d77",
                            Email = "bob@gmail.com",
                            EmailConfirmed = true,
                            FirstName = "Bob",
                            LastName = "Smith",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEF414K6QlWyAXvrV0t87Caj90023bkHn7nwVxNZ91uDVGz9zP0mpg1sxayrR1nBQkg==",
                            PhoneNumberConfirmed = false,
                            ProfileImgUrl = "https://i1.sndcdn.com/avatars-pOLSo9QjSMPjQ6zF-D9J8mg-t500x500.jpg",
                            SecurityStamp = "d81bc5e4-0728-4535-b901-44cdbaabb218",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Assignment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AssignedDate = new DateTime(2025, 1, 11, 15, 5, 0, 266, DateTimeKind.Local).AddTicks(2343),
                            Deadline = new DateTime(2025, 1, 18, 15, 5, 0, 266, DateTimeKind.Local).AddTicks(2344),
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.AssignmentSubmission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SubmissionDate = new DateTime(2025, 1, 11, 15, 5, 0, 266, DateTimeKind.Local).AddTicks(3472)
                        });
                });
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Exam", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExamDate = new DateTime(2025, 2, 11, 15, 5, 0, 266, DateTimeKind.Local).AddTicks(5342),
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClassId = 1,
                            EnrollmentDate = new DateTime(2024, 10, 11, 15, 5, 0, 266, DateTimeKind.Local).AddTicks(6415),
            ...
            modelBuilder.Entity("SchoolBook.Data.Models.Teacher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HireDate = new DateTime(2015, 1, 11, 15, 5, 0, 266, DateTimeKind.Local).AddTicks(8282),
